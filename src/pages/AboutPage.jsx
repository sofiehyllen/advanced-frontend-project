		...
		<motion.section variants={pageFade} initial='hidden' animate='visible'>
			...
			<div className='md:flex'>
				...
				<div className='md:order-2 md:pl-5 xl:w-full'>
					<p className='bodytext1 pt-5'>
						Velkommen til din lokale frisørsalon i hjertet af Ålbæk, hvor skønhed og stil forenes. Vi er stolte af at
						være din nære og personlige frisør, ledet af ejeren Pernille Thomsen.
						<br />
						<br />
						Hos os kombineres ekspertise med en varm atmosfære, og vores dedikerede team af stylister er klar til at
						skabe den perfekte frisure, der passer til netop dig. Oplev den unikke charme i vores salon, hvor dit hår
						er i trygge hænder.
						<br />
						<br />
						Vores team består af erfarne frisører, dygtige barberere og dedikerede kosmetologer, der alle deler en
			...
			<div>
				<div>
					...
					<p className='bodytext1 max-w-2xl pt-4'>
						Mød vores passionerede team af erfarne frisører, dedikerede kosmetologer, dygtige barberere og engagerede
						ejere.
					</p>
				</div>
