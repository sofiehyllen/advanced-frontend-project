...
const Favorites = () => {
	...
	return (
		<div className='mb-10'>
			...
			{favoriteMessage && (
				<div className=' heading3 z-50 fixed xl:text-sm top-10 right-10 p-4 bg-black text-white'>{favoriteMessage}</div>
			)}
							...
							<div className='mt-4 block md:w-full relative'>
								...
								<Link to={`/products/${favorite.id}`}>
									<div className='h-full relative'>
										...
										<div
											className='absolute top-0 right-0 pt-1 cursor-pointer'
											onClick={(e) => {
												e.preventDefault();
								...
								<div>
									...
									{/* Pris på produktet */}
									<p className='heading2 mt-2'>{favorite.price} kr.</p>
								</div>
							</div>
						</li>
					))}
