...
const SortSection = () => {
	...
	const categories = [
		...
		{ id: 2, category: ['kosmetolog'], title: 'Kosmetolog', name: 'Eva Nipali', src: kollega2 },
		{ id: 3, category: ['frisør'], title: 'Frisør/Barber', name: 'Rasmus Bjerggaard', src: kollega3 },
		{ id: 4, category: ['frisør'], title: 'Frisør/Barber', name: 'Klaus Sezani', src: kollega4 },
		...
		{ id: 7, category: ['kosmetolog', 'frisør'], title: 'Frisør/Kosmetolog', name: 'Sofie Bro', src: kollega7 },
		{ id: 8, category: ['kosmetolog'], title: 'Kosmetolog', name: 'Magnus Johansen', src: kollega8 },
		{ id: 9, category: ['Frisør'], title: 'Frisør', name: 'Karoline Vinter', src: kollega9 },
	...
	return (
		<div className='mx-auto'>
			<div className='flex items-center justify-end space-x-4 md:mr-6'>
				<Link
					to='#'
					className={`heading3 py-2 md:px-4 ${selectedCategory === 'all' ? 'underline underline-offset-2' : ''}`}
					onClick={() => handleButtonClick('all')}>
					Alle
				</Link>
				<Link
					to='#'
					className={`heading3 py-2 md:px-4 ${selectedCategory === 'frisør' ? 'underline underline-offset-2' : ''}`}
					onClick={() => handleButtonClick('frisør')}>
					Frisør
				</Link>
				<Link
					to='#'
					className={`heading3 py-2 md:pl-4 ${selectedCategory === 'kosmetolog' ? 'underline underline-offset-2' : ''}`}
			...
			<div className=' flex flex-wrap justify-center'>
				{filteredCategories.map((item) => (
					<div key={item.id} className='text-center w-1/2 xl:w-1/3 md:p-5'>
